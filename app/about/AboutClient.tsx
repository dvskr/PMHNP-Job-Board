          ...
          <div className="ab-clay-stage">
            <div className="ab-diorama">
              <div className="ab-scene" style={{ minHeight: 320, background: 'linear-gradient(160deg, #D6E8DE, #B5D1C3)', padding: 0 }}>
                <Image src="https://sggccmqjzuimwlahocmy.supabase.co/storage/v1/object/public/site-assets/images/about/diorama_new_grad.webp" alt="New Grad residency" width={800} height={600} sizes="(max-width: 960px) 50vw, 260px" quality={90} loading="lazy" style={{ width: '100%', flex: 1, objectFit: 'cover', borderRadius: '28px 28px 0 0' }} />
              ...
              <div className="ab-scene teal" style={{ minHeight: 380, padding: 0 }}>
                <Image src="https://sggccmqjzuimwlahocmy.supabase.co/storage/v1/object/public/site-assets/images/about/diorama_inpatient.webp" alt="Inpatient psychiatric" width={800} height={600} sizes="(max-width: 960px) 50vw, 260px" quality={90} loading="lazy" style={{ width: '100%', flex: 1, objectFit: 'cover', borderRadius: '28px 28px 0 0' }} />
              ...
              <div className="ab-scene coral" style={{ minHeight: 350, padding: 0 }}>
                <Image src="https://sggccmqjzuimwlahocmy.supabase.co/storage/v1/object/public/site-assets/images/about/diorama_telehealth.webp" alt="Telehealth remote practice" width={800} height={600} sizes="(max-width: 960px) 50vw, 260px" quality={90} loading="lazy" style={{ width: '100%', flex: 1, objectFit: 'cover', borderRadius: '28px 28px 0 0' }} />
              ...
              <div className="ab-scene" style={{ minHeight: 310, background: 'linear-gradient(160deg, #F3D7A8, #E3BC7B)', padding: 0 }}>
                <Image src="https://sggccmqjzuimwlahocmy.supabase.co/storage/v1/object/public/site-assets/images/about/diorama_outpatient.webp" alt="Outpatient community clinics" width={800} height={600} sizes="(max-width: 960px) 50vw, 260px" quality={90} loading="lazy" style={{ width: '100%', flex: 1, objectFit: 'cover', borderRadius: '28px 28px 0 0' }} />
        ...
        <div className="ab-two-col">
          ...
          <div>
            <div className="ab-diorama-card mint" style={{ padding: 0 }}>
              <Image src="https://sggccmqjzuimwlahocmy.supabase.co/storage/v1/object/public/site-assets/images/about/diorama_candidates.webp" alt="Career growth for PMHNPs" width={1000} height={750} sizes="(max-width: 960px) 100vw, 522px" quality={90} loading="lazy" style={{ width: '100%', flex: 1, objectFit: 'cover', borderRadius: '40px 40px 0 0' }} />
        ...
        <div className="ab-two-col flip">
          <div>
            <div className="ab-diorama-card peach" style={{ padding: 0 }}>
              <Image src="https://sggccmqjzuimwlahocmy.supabase.co/storage/v1/object/public/site-assets/images/about/diorama_employers.webp" alt="Employer hiring dashboard" width={1000} height={750} sizes="(max-width: 960px) 100vw, 522px" quality={90} loading="lazy" style={{ width: '100%', flex: 1, objectFit: 'cover', borderRadius: '40px 40px 0 0' }} />
              <div style={{ padding: '20px 28px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
