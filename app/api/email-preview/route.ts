...
import {
  ...
  featureRowV2, spacerV2, closeContentV2,
  unsubscribeFooterV2,
  V2, SANS, SERIF,
    ...
    fn: () => {
      ...
      return emailShellV2(`
          ${headerBlockV2('Welcome to PMHNP Hiring', '')}
                ...
                <tr>
                  <td class="content-pad" style="padding:0 40px;">
                    <p style="margin:0;font-family:${SERIF};font-size:26px;font-weight:700;color:${V2.textHeading};text-align:center;">
                  ...
                  <td class="content-pad" style="padding:0 40px;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td valign="middle">
                          <p style="margin:0 0 4px;font-family:${SANS};font-size:15px;font-weight:700;color:${V2.textHeading};">Build your profile</p>
                          <p style="margin:0;font-family:${SANS};font-size:14px;color:${V2.textMuted};line-height:1.5;">Take 60 seconds to add your credentials, specialties, and location preferences.</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                  ...
                  <td class="content-pad" style="padding:0 40px;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td valign="middle">
                          <p style="margin:0 0 4px;font-family:${SANS};font-size:15px;font-weight:700;color:${V2.textHeading};">Turn on AI alerts</p>
                          <p style="margin:0;font-family:${SANS};font-size:14px;color:${V2.textMuted};line-height:1.5;">Get pinged the exact minute a perfectly matched role lands on the board.</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                  ...
                  <td class="content-pad" style="padding:0 40px;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td valign="middle">
                          <p style="margin:0 0 4px;font-family:${SANS};font-size:15px;font-weight:700;color:${V2.textHeading};">Connect directly</p>
                          <p style="margin:0;font-family:${SANS};font-size:14px;color:${V2.textMuted};line-height:1.5;">Connect to hiring managers directly, no recruiters involved.</p>
                        </td>
                      </tr>
                    </table>
                  </td>
