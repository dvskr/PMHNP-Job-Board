      ...
      return emailShellV2(`
        ...
        <tr><td class="content-pad" style="padding:0 40px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr>
            ...
            <td width="70%" valign="top">
              <p style="margin:0;font-family:${SERIF};font-size:17px;color:${V2.textBody};line-height:1.7;">We found <strong>3 new positions</strong> matching your preferences, posted within the last 24 hours.</p>
            </td>
          </tr></table>
        </td></tr>
        ${spacerV2(20)}
