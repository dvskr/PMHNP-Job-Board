...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with the PMHNP Hiring team. Contact us for job seeker support, employer inquiries, technical help, or general feedback. We respond within 24 to 48 hours.',
  alternates: {
