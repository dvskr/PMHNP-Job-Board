...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark" suppressHydrationWarning style={{ backgroundColor: '#060E18', color: '#F1F5F9', scrollbarWidth: 'none', msOverflowStyle: 'none' } as React.CSSProperties}>
      <head>
