      ...
      <div style={{ background: 'linear-gradient(180deg, #F0FDFA 0%, #E6FAF5 50%, #F0FDFA 100%)' }}>
        <section style={{ maxWidth: '1000px', margin: '0 auto', padding: '56px 20px' }}>
          ...
          <div className="cat-explore-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '14px' }}>
            {[{ href: '/jobs/part-time', label: 'Part-Time', sub: 'Flexible hours', icon: '/images/categories/clay_icon_parttime.png' }, { href: '/jobs/contract', label: 'Contract', sub: 'Fixed-term roles', icon: '/images/categories/clay_icon_contract.png' }, { href: '/jobs/locum-tenens', label: 'Locum Tenens', sub: 'Travel assignments', icon: '/images/categories/clay_icon_locumtenens.png' }, { href: '/jobs/full-time', label: 'Full-Time', sub: 'Standard schedules', icon: '/images/categories/clay_icon_fulltime.png' }, { href: '/salary-guide', label: 'Salary Guide', sub: '2026 data', icon: '/images/categories/clay_icon_salary.png' }, { href: '/jobs/locations', label: 'By Location', sub: '50 states', icon: '/images/categories/clay_icon_location.png' }].map(c => (
