...
const fulltimeFaqs = [
  { question: 'What is a Full-Time PMHNP role?', answer: 'Full-Time PMHNP positions focus on psychiatric mental health care in full-time settings, offering specialized clinical opportunities.' },
  { question: 'What does a Full-Time PMHNP earn?', answer: 'Full-Time PMHNPs typically earn $130K-180K annually depending on location, experience, and setting.' },
  ...
  { question: 'How do I find full-time positions?', answer: 'Browse our curated full-time job listings above, set up alerts, and apply directly through our platform.' },
];
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `Find ${stats.totalJobs} full-time PMHNP jobs paying $130K-180K+. Browse psychiatric nurse practitioner positions.`,
  ...
  return (
    <div style={{ backgroundColor: '#FDFBF7' }}>
      <BreadcrumbSchema items={[
        ...
        { name: "Full-Time", url: "https://pmhnphiring.com/jobs/full-time" }
      ]} />
