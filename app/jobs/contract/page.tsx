...
const contractFaqs = [
  { question: 'What is a Contract PMHNP role?', answer: 'Contract PMHNP positions focus on psychiatric mental health care in contract settings, offering specialized clinical opportunities.' },
  { question: 'What does a Contract PMHNP earn?', answer: 'Contract PMHNPs typically earn $130K-180K annually depending on location, experience, and setting.' },
  ...
  { question: 'How do I find contract positions?', answer: 'Browse our curated contract job listings above, set up alerts, and apply directly through our platform.' },
];
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `Find ${stats.totalJobs} contract PMHNP jobs paying $130K-180K+. Browse psychiatric nurse practitioner positions.`,
    alternates: { canonical: 'https://pmhnphiring.com/jobs/contract' },
  };
}
        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 24px' }}>
          <div className="cat-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ fontSize: '16px', color: '#3D2E26', lineHeight: 1.7, margin: '0 0 36px', maxWidth: '440px' }}>Browse contract psychiatric nurse practitioner positions with competitive pay and benefits.</p>
              <Link href="/jobs?q=contract" className="cat-cta-primary" style={{ padding: '16px 40px', borderRadius: '16px', fontWeight: 700, fontSize: '15px', background: '#0D9488', color: '#fff', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '10px', boxShadow: '4px 4px 14px rgba(13,148,136,0.25)' }}>Browse Contract Jobs <ArrowRight size={17} /></Link>
            </div>
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3">
            ...
            <div style={{ textAlign: 'center', marginTop: '32px' }}>
              <Link href="/jobs?q=contract" className="cat-cta-primary" style={{ padding: '14px 32px', borderRadius: '14px', fontWeight: 700, fontSize: '14px', background: '#0D9488', color: '#fff', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '8px', boxShadow: '4px 4px 12px rgba(13,148,136,0.2)' }}>Browse All Contract Jobs <ArrowRight size={16} /></Link>
            </div>
          </div>
        ...
        <section style={{ maxWidth: '1000px', margin: '0 auto', padding: '48px 20px 40px' }}>
          ...
          <div className="cat-bento-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '14px' }}>
            <div className="cat-bento-card" style={{ ...clayCard, gridColumn: 'span 6', padding: '28px 24px' }}>
              ...
              <p style={{ fontSize: '13px', color: '#5A4A42', lineHeight: 1.6, margin: 0 }}>Focus on contract psychiatric care with dedicated clinical environments.</p>
            </div>
            <div className="cat-bento-card" style={{ ...clayCard, gridColumn: 'span 6', padding: '28px 24px' }}>
              <h3 style={{ fontSize: '16px', fontWeight: 800, color: '#1A2E35', margin: '0 0 8px' }}>Competitive Pay</h3>
              <p style={{ fontSize: '13px', color: '#5A4A42', lineHeight: 1.6, margin: 0 }}>Contract PMHNPs earn $130K-180K with benefits, loan repayment, and bonuses.</p>
            </div>
            <div className="cat-bento-card" style={{ ...clayCard, gridColumn: 'span 6', padding: '28px 24px' }}>
              <h3 style={{ fontSize: '16px', fontWeight: 800, color: '#1A2E35', margin: '0 0 8px' }}>Growing Demand</h3>
              <p style={{ fontSize: '13px', color: '#5A4A42', lineHeight: 1.6, margin: 0 }}>High demand for contract PMHNPs nationwide with strong job security.</p>
            </div>
            <div className="cat-bento-card" style={{ ...clayCard, gridColumn: 'span 6', padding: '28px 24px' }}>
              <h3 style={{ fontSize: '16px', fontWeight: 800, color: '#1A2E35', margin: '0 0 8px' }}>Career Growth</h3>
              <p style={{ fontSize: '13px', color: '#5A4A42', lineHeight: 1.6, margin: 0 }}>Advance from clinical roles to leadership positions in contract settings.</p>
            </div>
          </div>
        </section>
      </div>
