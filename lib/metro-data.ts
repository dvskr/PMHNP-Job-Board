...
export const METRO_CITIES: MetroCity[] = [
  {
    ...
    whyThisMetro: [
      'Highest PMHNP salaries in the US: $160K to $220K+ for experienced practitioners',
  ...
  },
  {
    ...
    whyThisMetro: [
      'California PMHNPs earn $150K to $200K+, among the highest nationally',
    ...
    faqs: [
      { question: 'What is the average PMHNP salary in Los Angeles?', answer: 'PMHNPs in Los Angeles earn $150,000 to $200,000+ annually. The average is approximately $170,000. Kaiser Permanente and academic medical centers offer competitive salaries plus excellent benefits. Private practice and telehealth roles can exceed $200K for experienced practitioners.' },
  ...
  },
  {
    ...
    faqs: [
      { question: 'What is the average PMHNP salary in Jacksonville, FL?', answer: 'PMHNPs in Jacksonville earn $130,000 to $170,000 annually. The average is approximately $148,000. When adjusted for Florida\'s zero state income tax and below-average cost of living, effective purchasing power is comparable to earning $175K+ in high-cost cities like NYC or LA.' },
  ...
  },
  {
    ...
    faqs: [
      { question: 'What is the average PMHNP salary in Tampa, FL?', answer: 'PMHNPs in the Tampa Bay area earn $128,000 to $165,000 annually, with the average around $145,000. When factoring in zero state income tax, this is equivalent to $160K-$185K in states with income tax like California or New York.' },
  ...
  },
  {
    ...
    faqs: [
      { question: 'What is the average PMHNP salary in Dallas, TX?', answer: 'PMHNPs in the DFW area earn $130,000 to $170,000 annually, with the average around $148,000. With zero state income tax, a DFW PMHNP keeps significantly more than colleagues in states like California (13.3% top rate) or New York (8.8% top rate).' },
  ...
  },
  {
    ...
    whyThisMetro: [
      'Among the highest-paying PMHNP markets: $155K to $210K+',
