...
const STEPS = [
    { img: 'https://sggccmqjzuimwlahocmy.supabase.co/storage/v1/object/public/site-assets/images/step-employer-post.webp', title: 'Post Your Listing', desc: `Start from a PMHNP template or generate the full description with AI. Set required experience and your post is live in minutes: your first post is $${config.firstPostPrice}, ${config.firstPostDiscountPercent()}% off the standard $${config.postingPrice}.` },
