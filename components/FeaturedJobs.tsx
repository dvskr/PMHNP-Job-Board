...
const STEPS = [
    { img: 'https://sggccmqjzuimwlahocmy.supabase.co/storage/v1/object/public/site-assets/images/step-profile.webp', title: 'Build Your Profile', desc: 'Upload your resume once, then add license states, credentials, years of experience, and salary range. Reuse it on every application.' },
