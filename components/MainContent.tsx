...
const BARE_ROUTES = ['/admin', '/messages', '/login', '/signup', '/forgot-password', '/reset-password', '/employer/login', '/employer/signup', '/employer/dashboard', '/employer/candidates', '/employer/applicants', '/employer/settings', '/pricing', '/contact', '/terms', '/privacy', '/faq', '/about', '/for-employers', '/for-programs', '/for-job-seekers', '/salary-guide', '/resources', '/blog', '/jobs', '/job-alerts', '/tools'];
