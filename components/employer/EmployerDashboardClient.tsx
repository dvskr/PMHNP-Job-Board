            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="mt-1" style={{ color: 'var(--text-secondary)' }}>{employerName}</p>
                    </div>
                    <Link
                        href="/post-job"
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-3 mb-2">
                                            <Link
                                                ...
                                                className={`text-lg font-semibold flex items-center gap-2 group ${job.isPublished && job.slug ? 'hover:text-teal-600' : ''}`}
