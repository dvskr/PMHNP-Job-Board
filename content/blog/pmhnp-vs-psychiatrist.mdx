...
| **Job Growth (10-yr)** | 40% (Much faster than avg) | 6% (Faster than avg) |
...
{`
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Both are in shortage, but PMHNP jobs are growing faster (40%) because they are more cost-effective for health systems to hire."
    }
  }]
}
`}
