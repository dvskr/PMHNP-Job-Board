...
<div className="bg-blue-50 border-l-4 border-blue-600 p-6 my-8 rounded-r-lg">
  ...
  <div className="mb-0 text-blue-800">
    Most healthcare employers use Applicant Tracking Systems (ATS) that scan resumes for specific keywords before a human ever sees them. To pass ATS screening, your PMHNP resume must include **clinical competency keywords** (psychopharmacology, diagnostic assessment, evidence-based treatment), **credential acronyms** (PMHNP-BC, ANCC, DEA, NPI), and **setting-specific terms** that match the job posting. A large share of applications never reach a hiring manager, because they are filtered out at this stage.
  </div>
</div>
...
Always spell out AND abbreviate, because ATS systems may search for either form:
...
- **MAT Waiver / X-Waiver** (for addiction treatment roles. Note that the X-waiver requirement was eliminated in 2023, but the training and capability are still valued)
...
Name the specific systems, because many recruiters filter candidates by EHR experience. A single mention can be the difference between a 65% and 85% match score:
...
- **CPRS / VistA** (VA systems, and **critical** for federal applications; if you've used these, prominently mention it)
...
3. **Exact dates** (month/year for both start and end dates; "2023-Present" isn't enough, so use "March 2023 to Present")
...
6. **Save as both .docx and .pdf**, then submit whichever the application system requests
...
A common concern is "keyword stuffing", meaning overloading your resume with keywords to game the ATS. Here's the guideline:
