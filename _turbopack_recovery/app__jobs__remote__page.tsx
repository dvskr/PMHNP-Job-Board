...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${stats.totalJobs} Remote PMHNP Jobs â€” Work From Home Psych NP ($130K-200K)`,
    description: `Find ${stats.totalJobs} remote PMHNP jobs paying $130K-$200K+. Work from home psychiatric nurse practitioner positions â€” telehealth, flexible schedules, no commute. Browse remote psych NP jobs updated daily.`,
    openGraph: {
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold mb-2" style={{ color: 'var(--color-primary)' }}>
                  ðŸ  Remote PMHNP Jobs (This Page)
                </h3>
                <p className="text-sm mb-3" style={{ color: 'var(--text-secondary)' }}>
                  Remote positions are any PMHNP job you can do from home â€” including telehealth patient care, chart reviews, utilization review, clinical documentation, peer consulting, and administrative roles. <strong>Not all remote jobs involve direct patient care.</strong>
                </p>
              </div>
              <div>
                <h3 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>
                  ðŸ’» <Link href="/jobs/telehealth" className="hover:underline" style={{ color: 'var(--color-primary)' }}>Telehealth PMHNP Jobs â†’</Link>
                </h3>
                <p className="text-sm mb-3" style={{ color: 'var(--text-secondary)' }}>
