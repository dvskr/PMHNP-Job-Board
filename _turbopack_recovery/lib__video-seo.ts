...
export const PAGE_VIDEO_SEO: Record<string, PageVideoSEO> = {
    '/': {
        ...
        description: 'Scroll through the PMHNP Hiring homepage â€” browse 10,000+ psychiatric nurse practitioner jobs from 3,000+ companies across all 50 states with salary transparency.',
        duration: 20,
    ...
    '/about': {
        ...
        description: 'Learn about PMHNP Hiring â€” our mission, data methodology, and how we aggregate psychiatric mental health nurse practitioner jobs from thousands of sources.',
        duration: 20,
        uploadDate: UPLOAD_DATE,
    },
    '/for-employers': {
    ...
    '/for-job-seekers': {
        ...
        description: 'Explore career resources for PMHNP job seekers â€” job search tools, salary data, application features, and career guidance for psychiatric nurse practitioners.',
        duration: 18,
        uploadDate: UPLOAD_DATE,
    },
    '/faq': {
        ...
        title: 'PMHNP Hiring FAQ â€” Frequently Asked Questions',
        description: 'Answers to common questions about PMHNP Hiring â€” job posting, salary transparency, job alerts, employer features, and how the platform works.',
        duration: 17,
        uploadDate: UPLOAD_DATE,
    },
    '/contact': {
    ...
    '/privacy': {
        ...
        description: 'Review the PMHNP Hiring privacy policy â€” how we collect, use, and protect your personal information on our psychiatric nurse practitioner job board.',
        duration: 30,
        uploadDate: UPLOAD_DATE,
    },
    '/terms': {
    ...
    '/resources': {
        ...
        description: 'Free career resources for psychiatric nurse practitioners â€” salary guides, certification info, interview prep, remote work advice, and professional development tools.',
        duration: 17,
        uploadDate: UPLOAD_DATE,
    },
    '/salary-guide': {
        ...
        title: '2026 PMHNP Salary Guide â€” State by State Comparison',
    ...
    '/jobs': {
        ...
        title: 'PMHNP Job Search â€” Browse Thousands of Listings',
    ...
    '/jobs/remote': {
        ...
        title: 'Remote PMHNP Jobs â€” Work From Home Positions',
    ...
    '/jobs/telehealth': {
        ...
        title: 'Telehealth PMHNP Positions â€” Virtual Psychiatric Care',
    ...
    '/jobs/travel': {
        ...
        title: 'Travel PMHNP Nursing Jobs â€” Contract Positions',
    ...
    '/jobs/per-diem': {
        ...
        title: 'Per Diem PMHNP Jobs â€” Flexible Positions',
    ...
    '/jobs/new-grad': {
        ...
        title: 'New Graduate PMHNP Jobs â€” Entry Level Positions',
    ...
    '/job-alerts': {
        ...
        title: 'PMHNP Job Alerts â€” Get Notified of New Positions',
