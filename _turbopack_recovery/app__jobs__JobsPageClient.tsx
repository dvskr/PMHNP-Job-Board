                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    >
                      ...
                      <option value="salary">Salary: High â†’ Low</option>
                    </select>
                    <ChevronDown style={{
                  ...
                  {/* View Mode Toggle â€” hidden on mobile, grid is default */}
...
/**
 * StickyFilterSidebar â€” JS-based fixed sidebar that stays pinned while scrolling.
...
function StickyFilterSidebar({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const adjustForFooter = () => {
      ...
      if (footerTop < viewportH) {
        // Footer is visible â€” shrink sidebar to stop above it
  ...
  return (
    <>
      ...
      />
      {/* Fixed panel that stays pinned â€” always rendered, hidden until measured */}
      <div
        ref={sidebarRef}
        className="hidden lg:block"
        style={{
