 ...
 *  A) PMHNP Career Pulse  â€” industry stats
 *  C) Application Tips    â€” contextual advice
 * â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */

/* â”€â”€ Clay card wrapper â”€â”€ */
...
/* â”€â”€ Helper: pick tips based on job attributes â”€â”€ */
function getTips(props: {
  ...
  if (props.isRemote || props.isTelehealth) {
    tips.push({ icon: 'ðŸ–¥ï¸', text: 'Highlight telehealth platform experience (Zoom, Doxy.me) and any virtual prescribing workflows.' });
  }
  if (props.mode?.toLowerCase().includes('contract') || props.jobType?.toLowerCase().includes('contract')) {
    tips.push({ icon: 'ðŸ“‹', text: 'Mention your malpractice insurance status and willingness to credential with new payers.' });
  }
  if (props.jobType?.toLowerCase().includes('full-time')) {
    tips.push({ icon: 'ðŸ¥', text: 'Ask about supervision ratios, patient panel size, and caseload expectations in your interview.' });
  }
  if (props.isNewGrad) {
    tips.push({ icon: 'ðŸŽ“', text: 'Emphasize clinical rotation hours and any specialty electives in psych settings.' });
  }

  // Defaults
  if (tips.length < 3) {
    const defaults = [
      { icon: 'âœ¨', text: 'Tailor your cover letter to mention the specific patient population this role serves.' },
      { icon: 'ðŸ“„', text: 'Include your NPI number, active license states, and DEA registration on your resume.' },
      { icon: 'ðŸ’¬', text: 'Prepare 2-3 clinical case examples that show your diagnostic reasoning skills.' },
    ];
...
export function CareerPulseCard() {
  return (
    <div style={{
      ...
      {/* Illustration â€” edge-to-edge, lavender mood */}
      <div style={{
        position: 'relative',
        width: '100%',
        height: '160px',
      ...
      <div style={{ padding: '18px 20px 20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <StatPebble emoji="ðŸ“ˆ" value="43%" label="Projected growth 2024-2034" color="#D5F5F1" />
          <StatPebble emoji="ðŸ’°" value="$160K+" label="Median annual salary" color="#FDE68A" />
          <StatPebble emoji="ðŸ¥" value="2,400+" label="Active openings nationwide" color="#BFDBFE" />
        </div>
...
export function ApplicationTipsCard({
  ...
  return (
    <div style={{
      ...
      {/* Illustration â€” edge-to-edge, warm peach mood */}
      <div style={{
        position: 'relative',
        width: '100%',
        height: '160px',
