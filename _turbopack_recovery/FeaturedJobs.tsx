...
const STEPS = [
    ...
    { img: '/images/step-connect.png', title: 'Connect Directly', desc: 'Reach hiring managers â€” no recruiters, no middlemen.' },
...
export default function FeaturedJobs({ jobs }: FeaturedJobsProps) {
    ...
    return (
        <section className="fjs-wrap">
            ...
            {/* â”€â”€ SPLIT: Process Left / Jobs Right â”€â”€ */}
            <div className="fjs-split" style={{ position: 'relative', zIndex: 1 }}>

                {/* â•â•â• LEFT: Vertical process spine â•â•â• */}
                <motion.div
                ...
                {/* â•â•â• RIGHT: Featured jobs â•â•â• */}
                <motion.div
