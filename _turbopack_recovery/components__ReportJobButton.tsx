...
const REPORT_REASONS = [
    { value: 'expired', label: 'Expired / Closed', icon: 'â°' },
    { value: 'wrong_salary', label: 'Wrong salary', icon: 'ðŸ’°' },
    { value: 'scam', label: 'Scam / Spam', icon: 'ðŸš«' },
    { value: 'duplicate', label: 'Duplicate', icon: 'ðŸ“‹' },
    { value: 'wrong_info', label: 'Wrong info', icon: 'ðŸ“' },
