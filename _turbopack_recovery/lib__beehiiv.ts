 ...
 *
 * Required env vars:
 *   BEEHIIV_API_KEY         â€” API key from Beehiiv dashboard
 *   BEEHIIV_PUBLICATION_ID  â€” Publication ID (starts with pub_)
 */
 ...
 *
 * This is fire-and-forget â€” it runs in the background and never
