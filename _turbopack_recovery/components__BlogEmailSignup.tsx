...
export default function BlogEmailSignup({ source }: { source: string }) {
    ...
    useEffect(() => {
        ...
        slot.innerHTML = `
            <div class="mid-article-email-box" style="margin:32px 0;padding:20px;border-radius:12px;text-align:center">
                <p style="font-weight:700;font-size:15px;margin:0 0 4px" class="mid-article-title">ðŸ“¬ Enjoying this article?</p>
                ...
                <p id="mid-signup-msg" style="font-size:12px;color:#2DD4BF;font-weight:600;margin:8px 0 0;display:none">âœ“ Subscribed!</p>
            </div>
            <style>
    ...
    if (status === 'done') {
        return <p style={{ fontSize: '14px', color: '#2DD4BF', fontWeight: 700 }}>âœ“ You&apos;re subscribed!</p>;
    }
