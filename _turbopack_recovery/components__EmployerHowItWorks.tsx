...
const STEPS = [
    { img: '/images/step-employer-post.png', title: 'Post Your Listing', desc: 'Fill out job details, preview, and publish â€” live in under 5 minutes. First 2 posts free.' },
        ...
        <section className="ehw-wrap">
            ...
            >
                ...
                <motion.div variants={fadeUp} style={{ textAlign: 'center', marginTop: '56px' }}>
                    ...
                    >
                        Post a Job â€” First 2 Free <ArrowUpRight size={15} />
                    </Link>
                </motion.div>
            </motion.div>
        </section>
