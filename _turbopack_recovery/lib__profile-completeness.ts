/**
 * Profile completeness scoring utility â€” v2
...
export function calculateCompleteness(profile: ProfileDataV2 | null | undefined): CompletenessResult {
    ...
    // â”€â”€ Professional Credentials (25%) â”€â”€
    {
        let earned = 0
        const missing: string[] = []
    ...
    // â”€â”€ Screening & Responses (10%) â”€â”€
    {
        let earned = 0
        const missing: string[] = []
