...
/*
 * Header â€” Linear-inspired, Lora branding.
 * Logo left â† gap â†’ nav | divider | auth right.
...
export default function Header() {
  ...
  // Public nav â€” shown when NOT logged in
  ...
  // Logged-in job seeker nav â€” minimal, app-focused
  ...
  // Logged-in employer nav â€” minimal, app-focused
  ...
  // Hide header on auth pages â€” they have their own branding
    ...
    <>
      ...
      >
        <div className="w-full max-w-[1440px] mx-auto px-8 xl:px-12 h-full flex items-center justify-between">
          ...
          {/* â•â•â• RIGHT: Nav + Divider + Auth â•â•â• */}
