    ...
    useEffect(() => {
        async function loadProfile() {
            try {
                ...
                // Profile load failed â€” not critical
            } finally {
        ...
        async function loadScreeningQuestions() {
            try {
                ...
                // Non-critical â€” form works without questions
            }
        }
                        ...
                        <div className="space-y-2">
                            {similarJobs.map(job => (
                                ...
                                >
                                    ...
                                    <p className="text-xs mt-0.5" style={{ color: 'var(--text-tertiary)' }}>{job.employer} Â· {job.location}</p>
                                </Link>
                            ))}
                        </div>
                    </div>
                    ...
                    {coverLetterMode === 'write' ? (
                        ...
                        >
                            <div className="flex items-center gap-3 flex-1">
                                ...
                                <div>
                                    <p className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                                        {coverLetterUrl ? 'Cover letter uploaded âœ“' : 'Upload cover letter'}
                                    </p>
                                    <p className="text-xs" style={{ color: 'var(--text-tertiary)' }}>
                                        PDF, up to 5MB
                                    </p>
