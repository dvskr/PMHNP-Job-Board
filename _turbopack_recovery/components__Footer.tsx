 ...
 *  Footer â€” Dark, clean, professional
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Single-row bottom bar: Logo + Tagline + Links + Socials + Copyright */}
          <div
            style={{
              display: 'flex',
              flexWrap: 'wrap',
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <p style={{ fontSize: '13px', color: '#78716c', margin: 0, whiteSpace: 'nowrap' }}>
                The #1 specialized job board for psychiatric nurse practitioners.
              </p>
            </div>

            {/* Right: Links + Socials + Copyright */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              ...
              <p style={{ fontSize: '13px', color: '#57534e', margin: 0, whiteSpace: 'nowrap' }}>
                Â© {new Date().getFullYear()} PMHNP Hiring
              </p>
            </div>
          </div>
        </div>
