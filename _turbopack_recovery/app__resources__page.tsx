...
export const metadata: Metadata = {
  title: 'PMHNP Resources & Career Guides â€” 85+ Free Articles',
...
/* â”€â”€â”€ Featured guides data â”€â”€â”€ */
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@type': 'CollectionPage',
        name: `PMHNP Resources & Career Guides â€” ${currentYear}`,
      ...
      <div style={{ background: 'linear-gradient(180deg, #FFF5EE 0%, #FDE8D8 40%, #FFF5EE 100%)' }}>
        <section style={{ maxWidth: '1100px', margin: '0 auto', padding: '80px 20px 0', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '17px', color: '#5A4A42', maxWidth: '600px', margin: '0 auto 32px', lineHeight: 1.6 }}>
            Everything you need for your PMHNP career â€” from licensure requirements to salary negotiation.
          </p>
          ...
          {/* â”€â”€â”€ Section 2: Featured Guides Bento â”€â”€â”€ */}
          <div style={{ textAlign: 'left' }}>
            ...
            {/* 1099 vs W2 â€” full-width banner */}
            <Link href="/resources/1099-vs-w2" className="emp-bento-card" style={{
              ...
              <div style={{ padding: '24px 28px' }}>
                ...
                <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#1A2E35', margin: '10px 0 6px' }}>1099 vs W2 for PMHNPs â€” Complete Comparison</h2>
      ...
      <section style={{ background: 'linear-gradient(180deg, #F1F5F9 0%, #E2E8F0 50%, #F1F5F9 100%)', padding: '80px 20px', marginTop: '24px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          {/* â”€â”€â”€ Licensure Checker Tool â”€â”€â”€ */}
            ...
            {sortedStates.map(s => {
              ...
              return (
                ...
                >
                  ...
                  <p style={{ fontSize: '11px', color: '#6366F1', textAlign: 'center', margin: 0, fontWeight: 500 }}>Read Guide â†’</p>
                </Link>
              );
            })}
          </div>
                    ...
                    <Link key={post.slug} href={`/blog/${post.slug}`} className="emp-bento-card" style={{
                      ...
                      {post.metaDescription && (
                        <p style={{ fontSize: '12.5px', color: '#5A4A42', lineHeight: 1.5, margin: 0, flex: 1 }}>
                          {post.metaDescription.length > 120 ? post.metaDescription.slice(0, 120) + 'â€¦' : post.metaDescription}
                        </p>
                      )}
