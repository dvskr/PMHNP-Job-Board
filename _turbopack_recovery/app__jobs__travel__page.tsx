...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${stats.totalJobs} Travel PMHNP Jobs â€” Locum Tenens Psych NP | $80-150/hr`,
...
export default async function TravelJobsPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      {/* ItemList Schema â€” enables job carousels in Google search */}
      {jobs.length > 0 && (
        <script
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-7xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
                      Choose contract lengths that fit your lifestyleâ€”from 4-week assignments to 6-month contracts. Take breaks between assignments as needed.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
              ...
              <div className="rounded-xl p-6" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
                ...
                <ul className="space-y-3 text-sm" style={{ color: 'var(--text-secondary)' }}>
                  <li className="flex gap-2">
                    <span style={{ color: 'var(--color-primary)' }} className="font-bold">â€¢</span>
          ...
          <div className="mt-12 rounded-xl p-6 md:p-8" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
                <div className="text-lg font-bold" style={{ color: 'var(--color-primary)' }}>$80â€“$150/hr</div>
              ...
              <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
                <div className="text-lg font-bold" style={{ color: 'var(--color-primary)' }}>$2,000â€“$4,000/mo</div>
              ...
              <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
                <div className="text-lg font-bold" style={{ color: 'var(--color-primary)' }}>$500â€“$1,200</div>
                <div className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>Travel Reimbursement</div>
                <div className="text-xs mt-1" style={{ color: 'var(--text-tertiary)' }}>Per assignment â€” flights, mileage, or lump sum</div>
              </div>
              <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
                <div className="text-lg font-bold" style={{ color: 'var(--color-primary)' }}>$3,000â€“$10,000</div>
            ...
            <p className="text-xs" style={{ color: 'var(--text-tertiary)' }}>
              Total annual compensation for travel psych NPs can exceed <strong>$200Kâ€“$250K</strong> when factoring in tax-free stipends. See our <Link href="/salary-guide" className="font-medium hover:underline" style={{ color: 'var(--color-primary)' }}>2026 PMHNP Salary Guide</Link> for permanent position comparisons.
            </p>
          </div>
          ...
          <div className="mt-8 rounded-xl p-6 md:p-8" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold mb-2" style={{ color: 'var(--color-primary)' }}>âœˆï¸ Travel / Locum Tenens</h3>
                <ul className="space-y-2 text-sm" style={{ color: 'var(--text-secondary)' }}>
                  <li>â€¢ Higher total compensation ($200K+)</li>
                  <li>â€¢ Tax-free housing and travel stipends</li>
                  <li>â€¢ Flexibility to take breaks between assignments</li>
                  <li>â€¢ Exposure to different practice settings</li>
                  <li>â€¢ No office politics â€” you&apos;re temporary</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>ðŸ  Permanent Positions</h3>
                <ul className="space-y-2 text-sm" style={{ color: 'var(--text-secondary)' }}>
                  <li>â€¢ Stable income and benefits (health, retirement)</li>
                  <li>â€¢ Build long-term patient relationships</li>
                  <li>â€¢ CME budget and paid conference time</li>
                  <li>â€¢ No re-credentialing every 3â€“6 months</li>
                  <li>â€¢ Opportunity for advancement and leadership</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="mt-12 mb-8 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link href="/salary-guide" className="block p-4 rounded-lg hover:shadow-sm transition-all" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
            <h3 className="font-semibold" style={{ color: 'var(--color-primary)' }}>ðŸ’° 2026 Salary Guide</h3>
          ...
          <Link href="/jobs/locations" className="block p-4 rounded-lg hover:shadow-sm transition-all" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
            <h3 className="font-semibold" style={{ color: 'var(--color-primary)' }}>ðŸ“ Jobs by Location</h3>
          ...
          <Link href="/jobs/remote" className="block p-4 rounded-lg hover:shadow-sm transition-all" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
            <h3 className="font-semibold" style={{ color: 'var(--color-primary)' }}>ðŸ  Remote Jobs</h3>
          ...
          <Link href="/jobs/new-grad" className="block p-4 rounded-lg hover:shadow-sm transition-all" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
            <h3 className="font-semibold" style={{ color: 'var(--color-primary)' }}>ðŸŽ“ New Grad Jobs</h3>
          ...
          <Link href="/jobs/telehealth" className="block p-4 rounded-lg hover:shadow-sm transition-all" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
            <h3 className="font-semibold" style={{ color: 'var(--color-primary)' }}>ðŸ’» Telehealth Jobs</h3>
