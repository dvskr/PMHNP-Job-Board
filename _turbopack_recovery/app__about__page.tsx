      ...
      <section className="py-20 px-4" style={{ background: 'var(--bg-secondary)' }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
            The #1 dedicated job board for Psychiatric Mental Health Nurse Practitioners â€” trusted by thousands of PMHNPs nationwide
          </p>
        </div>
      </section>
          ...
          <Card padding="lg" variant="elevated">
            ...
            <div className="space-y-4 leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
              ...
              <p>
                ...
                and career data that PMHNPs deserve â€” helping practitioners make informed decisions about
