...
export default async function Home() {
  ...
  return (
    <>
      {/* Structured data â€” outside content div to prevent hydration mismatch */}
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "A PMHNP (Psychiatric Mental Health Nurse Practitioner) is an advanced practice registered nurse (APRN) who specializes in mental health care. PMHNPs â€” also called Psych NPs or behavioral health nurse practitioners â€” can diagnose and treat mental health conditions, prescribe medications, and provide psychotherapy. They hold a Master's or Doctoral degree in psychiatric nursing and are certified by the ANCC as PMHNP-BC.",
                },
              },
              {
                "@type": "Question",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "The PMHNP job outlook is exceptional, with the Bureau of Labor Statistics projecting 45% growth through 2032 â€” much faster than average. The mental health provider shortage (123 million Americans in designated shortage areas), expanded telehealth access, and growing awareness of mental health needs drive sustained demand nationwide.",
                },
              },
              {
                "@type": "Question",
      ...
      <div style={{ background: 'linear-gradient(180deg, #FDFBF7 0%, #F5D5C4 15%, #F0C4AF 50%, #FDFBF7 100%)' }}>
        ...
        {/* â”€â”€ Remaining sections (being redesigned) â”€â”€ */}
        <FeaturedJobsSection />
