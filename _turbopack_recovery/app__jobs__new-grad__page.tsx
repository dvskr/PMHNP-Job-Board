...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
    ...
    return {
        title: `${stats.totalJobs} New Grad PMHNP Jobs â€” Entry-Level Psych NP ($120K-160K)`,
        description: `Find ${stats.totalJobs} new grad PMHNP jobs starting at $120K+. Entry-level psychiatric nurse practitioner positions with mentorship, fellowships, and residency programs. No experience required â€” start your PMHNP career today.`,
...
export default async function NewGradJobsPage({ searchParams }: PageProps) {
    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: 'var(--bg-primary)' }}>
            ...
            <JobListViewTracker jobs={jobs.map((j: Job) => ({ id: j.id, title: j.title, employer: j.employer }))} listName="New Grad PMHNP Jobs" />
            {/* Hero Section */}
            ...
            <div className="container mx-auto px-4 py-8 md:py-12">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mt-12 rounded-xl p-6 md:p-8" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm mb-3" style={{ color: 'var(--text-secondary)' }}>
                                    Quality employers offer gradual caseload increasesâ€”starting with 4-6 patients per day
                    ...
                    <div className="mt-12 rounded-xl p-6 md:p-8" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
                        ...
                        <div className="grid md:grid-cols-3 gap-4 mb-4">
                            <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
                                <div className="text-lg font-bold" style={{ color: 'var(--color-primary)' }}>$115Kâ€“$135K</div>
                            ...
                            <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
                                <div className="text-lg font-bold" style={{ color: 'var(--color-primary)' }}>$130Kâ€“$155K</div>
                            ...
                            <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--bg-tertiary)' }}>
                                <div className="text-lg font-bold" style={{ color: 'var(--color-primary)' }}>$125Kâ€“$145K</div>
                    ...
                    <div className="mt-8 rounded-xl p-6 md:p-8" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
                        <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--text-primary)' }}>
                            ðŸš© Red Flags to Watch For as a New Grad Psych NP
                        </h2>
                        <p className="text-sm mb-4" style={{ color: 'var(--text-secondary)' }}>
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            <div className="flex gap-3">
                                <span className="text-red-500 font-bold flex-shrink-0">âš ï¸</span>
                                <div>
                                    <div className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>Full caseload from day one</div>
                                    <div className="text-xs" style={{ color: 'var(--text-tertiary)' }}>Quality employers ramp up over 3â€“6 months</div>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                <span className="text-red-500 font-bold flex-shrink-0">âš ï¸</span>
                            ...
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs" style={{ color: 'var(--text-tertiary)' }}>Unrealistic for psych; 8â€“12/day is typical for new grads</div>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                <span className="text-red-500 font-bold flex-shrink-0">âš ï¸</span>
            ...
            <section className="mt-12 mb-8 container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <Link href="/jobs/travel" className="block p-4 rounded-lg hover:shadow-sm transition-all" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
                        <h3 className="font-semibold" style={{ color: 'var(--color-primary)' }}>âœˆï¸ Travel Jobs</h3>
