...
/*
 * Exact Wellfound "From the blog" CSS â€” source: DevTools inspection
 *
 * Row: padding 40px â†’ 64px on hover, bg â†’ #fff4f6, border-radius 12px, transition 0.3s
 ...
 * Arrow tab: 64Ã—32px, half-circle, absolute right:-16px, top:50px, rotate(-90deg), bg #ec2e3a
 */
...
const FEATURED_POSTS = [
    {
        ...
        description: 'Data from 8,500+ job postings reveals top-paying states, specialty premiums, and negotiation strategies that can add $15Kâ€“$25K to your offer.',
        href: '/blog/pmhnp-salary-guide-2026',
    },
    {
        category: 'Career Path',
        title: 'How to Become a PMHNP: The Complete Roadmap',
        description: 'From BSN to board certification â€” every step, timeline, and insider tip for launching your psychiatric NP career in 2026.',
    ...
    },
    {
        ...
        description: '62% of psych NP positions now offer telehealth. Find out which companies pay $130Kâ€“$200K for remote psychiatric care.',
    ...
    },
    {
        ...
        description: 'Cash-pay vs insurance, overhead costs, and how practice owners in FPA states are clearing $200Kâ€“$300K+ annually.',
