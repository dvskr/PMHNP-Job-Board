...
/* â”€â”€â”€ Requirements per state (common baseline + state-specific) â”€â”€â”€ */
    ...
    <div style={{ ...clayCard, padding: '0', overflow: 'hidden', border: '2px solid rgba(13,148,136,0.12)' }}>
      ...
      <div style={{ padding: '28px 32px', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
        ...
        <div style={{ position: 'relative', maxWidth: '400px' }}>
          ...
          >
            <option value="">Choose a stateâ€¦</option>
            {stateList.map(s => (
            ...
            {result.salary && (
              <div style={{
                ...
                <p style={{ fontSize: '12px', color: '#94A3B8', margin: '0 0 12px' }}>
                  Range: ${fmt(result.salary.minSalary)} â€“ ${fmt(result.salary.maxSalary)}
                </p>
      ...
      {/* â”€â”€â”€ Cite This Page â”€â”€â”€ */}
      <div style={{
        padding: '24px 32px', borderTop: '1px solid rgba(0,0,0,0.06)',
        background: 'rgba(0,0,0,0.015)',
      }}>
        <h3 style={{ fontSize: '16px', fontWeight: 700, color: '#1A2E35', margin: '0 0 10px' }}>ðŸ“‹ Cite This Page</h3>
