...
export default function HomepageHero({ jobCountDisplay }: HomepageHeroProps) {
    ...
    return (
        ...
        >
            {/* â”€â”€ Nurse crowd background â€” fills viewport, anchored bottom â”€â”€ */}
            <Image
                src="/hero-nurses.png"
            ...
            {/* â”€â”€ Top fade â€” cream fades into nurse crowd â”€â”€ */}
            <div
                style={{
                    position: 'absolute',
                    inset: 0,
