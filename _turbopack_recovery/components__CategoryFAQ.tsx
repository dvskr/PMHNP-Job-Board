...
const CATEGORY_FAQS: Record<string, (props: CategoryFAQProps) => FAQItem[]> = {
    ...
    'new-grad': ({ totalJobs }) => [
        ...
        },
        {
            ...
            answer: 'Yes â€” demand for PMHNPs far exceeds supply. New graduates are highly sought after, with many employers offering structured orientation, mentorship, and collaborative practice agreements. The psychiatric NP field has one of the highest job placement rates among all NP specialties.',
        },
        {
    ...
    'per-diem': ({ totalJobs }) => [
        ...
        },
        {
            ...
            answer: 'Yes â€” per diem PMHNPs can typically work at multiple facilities simultaneously. This is one of the main advantages of per diem work. You\'ll need to ensure you have proper credentialing and privileges at each facility, and check for any non-compete clauses in your agreements.',
        },
    ],
    ...
    outpatient: ({ totalJobs, avgSalary }) => [
        ...
        },
        {
            ...
            answer: 'Yes â€” outpatient experience is ideal preparation for private practice. In full practice authority states, PMHNPs can open independent practices. Most PMHNPs gain 2-3 years of supervised experience first, then transition to private practice earning $200K+ with full schedule control.',
        },
    ],
    'substance-abuse': ({ totalJobs }) => [
        ...
        },
        {
            ...
            answer: 'Yes â€” many substance abuse positions in underserved areas qualify for National Health Service Corps (NHSC) loan repayment up to $50,000 for 2 years of service. Positions at nonprofit employers also qualify for Public Service Loan Forgiveness (PSLF) after 10 years of qualifying payments.',
        },
    ],
    'child-adolescent': ({ totalJobs }) => [
        ...
        },
        {
            ...
            answer: 'Yes â€” school-based PMHNP positions are growing rapidly as districts address the youth mental health crisis. These roles typically follow the school calendar with summers off, offer competitive salaries, and provide a rewarding opportunity to serve children where they spend most of their day.',
        },
    ],
